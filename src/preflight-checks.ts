...
export async function checkDockerCLI(): Promise<PreflightResult> {
    try {
        ...
        return {
            success: false,
            error: 'Docker CLI is not installed. Please install Docker Desktop or Docker Engine.',
        };
    }
}
...
export async function checkDockerEngine(): Promise<PreflightResult> {
    try {
        ...
        return {
            success: false,
            error: 'Docker Engine is not running. Please start Docker Desktop or Docker daemon.',
        };
    }
}
