...
export function parseWorktreeName(
  name: string
): { worktreeId: string; branch: string } | null {
...
export function createWorktree(
  ...
  const worktreePath = targetDir
    ? join(targetDir, worktreeName)
    : join('..', worktreeName);
...
export function getWorktreeForWorktree(
  worktreeId: string
): WorktreeInfo | null {
