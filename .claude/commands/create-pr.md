...
4. Create a pull request using `gh pr create`. If your current branch starts with `dev-###`, always start the PR title with `[DEV-###] ` and use the remaining branch name as the PR title.
5. For the description, summarize the `git diff` in 2~3 lines for short PRs and 4~5 lines for big PRs.
